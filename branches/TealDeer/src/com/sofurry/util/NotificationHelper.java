...
public class NotificationHelper {
     ...
     */
    public void createNotification(CharSequence tickerText, CharSequence contentTitle) {
...
//        CharSequence tickerText = mContext.getString(R.string.download_ticker); //Initial text that appears in the status bar
        ...
        mContentTitle = contentTitle; //mContext.getString(R.string.content_title); //Full title of the notification in the pull down
